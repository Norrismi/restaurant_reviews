      ...
      <div className="rr-container">
        <div className="rr-header">
          ...
          <div className="rr-reviewer">
            <span>Review by:</span>
            {props.reviewer.name} {props.reviewer.lastname}
          </div>
        </div>
        <div className="rr-review">{props.restaurant.review}</div>
        <div className="rr-box">
          <div className="left">
            <div>{/* <span>Pages:</span> {props.reataurant.pages} */}</div>
            <div>{/* <span>Price:</span> {props.reataurant.price} */}</div>
          </div>
          <div className="right">
            <span>Rating</span>
            <div>
